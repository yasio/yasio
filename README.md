...
[![Release](https://img.shields.io/badge/release-v3.23.3-blue.svg)](https://github.com/halx99/yasio/releases)
...
```g++ yasio/xxsocket.cpp yasio/yasio.cpp yasio/ibstream.cpp yasio/obstream.cpp msvc/cpptest/cpptest.cpp --std=c++11 -lpthread -I./ -o cpptest && ./cpptest``` or ```g++ msvc/cpptest/cpptest.cpp --std=c++11 -DYASIO_HEADER_ONLY -lpthread -I./ -o cpptest && ./cpptest``` 
