...
{  
    ...
    cmake .. -GXcode -Bbuild_ios -DCMAKE_SYSTEM_NAME=iOS "-DCMAKE_OSX_ARCHITECTURES=armv7;arm64" -DYASIO_SSL_BACKEND=1 -DYASIO_HAVE_CARES=ON
...
function build_linux()
{
    ...
    cd $YASIO_ROOT/build
    mkdir -p build_linux
    cmake .. -G "Unix Makefiles" -Bbuild_linux -DCMAKE_BUILD_TYPE=Release -DYASIO_SSL_BACKEND=2 -DYASIO_HAVE_KCP=ON -DYASIO_HAVE_CARES=ON -DYAISO_BUILD_NI=YES -DCXX_STD=17 -DYASIO_VERBOSE_LOG=ON
