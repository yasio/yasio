...
#ifndef THELIB_ASIO_IO_SERVICE_HPP
#define THELIB_ASIO_IO_SERVICE_HPP

#if defined(_MSC_VER) && (_MSC_VER >= 1200)
# pragma once
#define THELIB_ASIO_HAS_IOCP 1
#define THELIB_ASIO_DECL
...
namespace detail {
#if defined(THELIB_ASIO_HAS_IOCP)
...
public:
   ...
   */
  THELIB_ASIO_DECL explicit io_service(std::size_t concurrency_hint);
   ...
   * without blocking.
   */
  THELIB_ASIO_DECL std::size_t run();
   ...
   * without blocking.
   */
  THELIB_ASIO_DECL std::size_t run(int& ec);
   ...
   * @throws boost::system::system_error Thrown on failure.
   */
  THELIB_ASIO_DECL std::size_t run_one();
   ...
   * @return The number of handlers that were executed.
   */
  THELIB_ASIO_DECL std::size_t run_one(int& ec);
   ...
   * @throws boost::system::system_error Thrown on failure.
   */
  THELIB_ASIO_DECL std::size_t poll();
   ...
   * @return The number of handlers that were executed.
   */
  THELIB_ASIO_DECL std::size_t poll(int& ec);
   ...
   * @throws boost::system::system_error Thrown on failure.
   */
  THELIB_ASIO_DECL std::size_t poll_one();
   ...
   * @return The number of handlers that were executed.
   */
  THELIB_ASIO_DECL std::size_t poll_one(int& ec);
   ...
   */
  THELIB_ASIO_DECL bool stopped() const;
...
private:
  ...
  thelib::asio::detail::service_registry* service_registry_;
...
public:
   ...
   */
  explicit work(thelib::asio::io_service& io_service);
  ...
  thelib::asio::io_service& get_io_service();
...
protected:
   ...
   */
  THELIB_ASIO_DECL service(thelib::asio::io_service& owner);

  /// Destructor.
  THELIB_ASIO_DECL virtual ~service();
...
private:
   ...
   */
  THELIB_ASIO_DECL virtual void fork_service(
      thelib::asio::io_service::fork_event event);

  friend class thelib::asio::detail::service_registry;
  struct key
  {
    key() : type_info_(0), id_(0) {}
    const std::type_info* type_info_;
    const thelib::asio::io_service::id* id_;
  } key_;

  thelib::asio::io_service& owner_;
  service* next_;
};
...
{
public:
  THELIB_ASIO_DECL service_already_exists();
};
...
{
public:
  THELIB_ASIO_DECL invalid_service_owner();
};
...
class service_id
  : public thelib::asio::io_service::id
{
};
...
template <typename Type>
class service_base
  : public thelib::asio::io_service::service
{
public:
  static thelib::asio::detail::service_id<Type> id;

  // Constructor.
  service_base(thelib::asio::io_service& io_service)
    : thelib::asio::io_service::service(io_service)
  {
  }
};

template <typename Type>
thelib::asio::detail::service_id<Type> service_base<Type>::id;
