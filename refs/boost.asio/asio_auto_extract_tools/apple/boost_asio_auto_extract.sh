...
boost_dir=/projects/inetlibs/boost_1_61_0
boost_asio_dir=/projects/inetlibs/boost.asio.1.0.161
...
do
  ...
  gcc pseudo.cpp -c -I$boost_asio_dir -DBOOST_ERROR_CODE_HEADER_ONLY -DBOOST_SYSTEM_NO_DEPRECATED -DBOOST_SYSTEM_NO_LIB -DBOOST_DATE_TIME_NO_LIB -DBOOST_REGEX_NO_LIB -DBOOST_ASIO_DISABLE_THREADS 2>compile_error.txt
  error_code=$?
