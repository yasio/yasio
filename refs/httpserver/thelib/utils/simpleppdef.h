...
#define _NEX_BEGIN namespace thelib {
#define _NEX_END   };
#define _EXX_BEGIN _NEX_BEGIN
#define _EXX_END _NEX_END
namespace next = thelib;
namespace nex = next;
namespace nx = nex;
namespace xx = nx;
#endif /* _POLITE_ALIAS */
...
#ifndef NEX_UNUSED
#define NEX_UNUSED(expression) (void)(expression)
#define _XXUNUSED NEX_UNUSED
#endif

#ifndef NEX_UNREACHABLE
#define NEX_UNREACHABLE assert(false)
#endif

#define NEX_STATICIZE_CLASS(className) private: \
	className(void); \
