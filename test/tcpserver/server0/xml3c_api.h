...
*                                                                             *
* Comment:                                                                    *
*     Please compile with defining macro _USING_LIBXML2 or _USING_XERCESC     *
*     Version history:                                                        *
...
public:
    ...
    bool            get_value(std::string& output) const; 
    std::string     get_property_value(const char* name) const;
    bool            get_property_value(const char* name, std::string& output) const; 
    ...
    void            set_property_value(const char* name, const char* value) const;
    void            set_property_value(const char* name, const std::string& value) const;
    ...
    _Ty             get_value(void) const;

    template<typename _Ty>
    bool            get_value(_Ty& output) const;

    template<typename _Ty>
    _Ty             get_property_value(const char* name) const;

    template<typename _Ty>
    bool            get_property_value(const char* name, _Ty& output) const;
